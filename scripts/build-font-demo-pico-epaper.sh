...
echo "After one full refresh: four centred lines, two at 16px and two at 12px,"
echo "the last one Polish, then every glyph of the 12px table in six lines of"
echo "21, black on white, held four seconds before the panel sleeps."
