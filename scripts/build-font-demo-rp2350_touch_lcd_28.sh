...
echo "then every glyph of the 12px table in four lines of 34, held four"
echo "seconds. The second line is white on blue, the third red, the fourth"
echo "green; blue that comes out red means the RGB565 byte swap was dropped."
